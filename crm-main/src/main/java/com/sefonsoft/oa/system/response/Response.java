package com.sefonsoft.oa.system.response;
...
import static com.sefonsoft.oa.system.emun.ResponseMessage.PARAM_ERROR;
...
public class Response<T> implements Serializable {
    ...
    public Response warning(String message) {
        this.meta = new Response.Meta(ResponseState.WARNING, message);
        return this;
    }

    public Response warning(String message, T data) {
