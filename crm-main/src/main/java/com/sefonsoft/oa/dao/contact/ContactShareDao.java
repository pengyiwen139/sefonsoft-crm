 ...
 */
public interface ContactShareDao {
    ...
    ContactInfo findContactInfo(@Param("customerId") String customerId, @Param("contactName") String contactName, @Param("telphone") String telphone);
