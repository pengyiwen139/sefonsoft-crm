...
public class SysDataRoleQueryDTO implements Serializable {

    private static final long serialVersionUID = -8358316706694937427L;
    ...
    */
    ...
    private List<SysRoleDeptQueryDTO> deptList;
