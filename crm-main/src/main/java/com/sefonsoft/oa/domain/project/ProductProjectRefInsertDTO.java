...
@Data
public class ProductProjectRefInsertDTO implements Serializable {
    ...
    */
    ...
    public ProductProjectRefInsertDTO(Integer productId, Integer saleCount, BigDecimal amount, String projectId, String operator, Date lastTime, Date createTime) {
