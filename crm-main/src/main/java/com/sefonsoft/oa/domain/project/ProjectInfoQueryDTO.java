 ...
 */
@ApiModel("项目查询展示类")
public class ProjectInfoQueryDTO implements Serializable {
   ...
   private Integer[] checkStatuses;
     ...
     * 查询资源池
     */
    private boolean shareProjects = false;
    
    /**
     * 商机ID
     */
    @ApiModelProperty("商机ID")
    private Integer bizOpportId;

    /**
     * 根据权限查询时，包括自己的项目
     */
    @ApiModelProperty("根据权限查询时，包括自己的项目")
     ...
     * 查询范围，1：全部；2：大区；3： 自己
     */
    @ApiModelProperty("查询范围，1：全部；2：大区；3： 自己")
    ...
    public boolean isShareProjects() {
      return shareProjects;
    }

    public void setShareProjects(boolean shareProjects) {
      this.shareProjects = shareProjects;
    }

    public Integer[] getCheckStatuses() {
      return checkStatuses;
    }

    public void setCheckStatuses(Integer[] checkStatuses) {
    ...
    public Integer getBizOpportId() {
      return bizOpportId;
    }

    public void setBizOpportId(Integer bizOpportId) {
      this.bizOpportId = bizOpportId;
    }
