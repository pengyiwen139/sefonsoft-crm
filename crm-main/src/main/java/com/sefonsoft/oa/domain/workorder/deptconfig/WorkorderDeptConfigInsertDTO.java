...
@AllArgsConstructor
@NoArgsConstructor
@ApiModel("派工单部门关联配置insert实体类")
public class WorkorderDeptConfigInsertDTO implements Serializable {

    private static final long serialVersionUID = -14820022562002182L;
