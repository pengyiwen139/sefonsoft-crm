...
@ApiModel("合同预测新增实体类")
public class ExpectContractInsertDTO implements Serializable {

    private static final long serialVersionUID = 6290192536582461770L;
    ...
    @Size(min = 1, max = 64, message = "预估签约时间，格式为2019-12,只需要传年月"+MAX_PARAM+",最大长为64")
